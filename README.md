# OpenAPI spec for the Moon Banking API

The most recent OpenAPI specification for the Moon Banking API is available at [moonbanking-openapi-spec.json](./moonbanking-openapi-spec.json).
